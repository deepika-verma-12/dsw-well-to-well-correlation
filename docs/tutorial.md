...
Install Dependencies Install the necessary Python package dependencies:
...
Open Notebook Navigate into the notebooks/ directory and open a target processing file (for example, J5_J7A.ipynb).
...
Review Results: The final cell renders a high-contrast well panel plot with dark-red tie-lines locking corresponding structural horizons across the stratigraphy. The resulting figure exports automatically as a publication-ready graphic file inside your local workspace.
